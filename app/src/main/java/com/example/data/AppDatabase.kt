        ...
        private suspend fun populateInitialData(db: AppDatabase) {
            ...
            survivalLevels.forEachIndexed { idx, sec ->
                initialAchievements.add(
                    AchievementEntity(
                        id = "survival_$sec",
                        title = "جون‌سخت! ($sec ثانیه)",
                        description = "یا خدا! توی یک راند $sec ثانیه آزگار دوام بیار و زنده بمون.",
                        category = "پایداری",
                        target = sec,
                        currentProgress = 0,
                        isUnlocked = false,
            ...
            nearMisses.forEachIndexed { idx, count ->
                initialAchievements.add(
                    AchievementEntity(
                        id = "near_miss_$count",
                        title = "لایی‌کش ملس ($count بار)",
                        description = "در یک راند $count بار خیلی مویی و مماس از بغل آوارها و سنگ‌ها لایی بکش.",
                        category = "مهارت",
                        target = count,
                        currentProgress = 0,
                        isUnlocked = false,
            ...
            levelTargets.forEachIndexed { idx, lvl ->
                initialAchievements.add(
                    AchievementEntity(
                        id = "game_level_$lvl",
                        title = "تاج‌گذاری لول $lvl",
                        description = "مرحله $lvl پر از چالش رو ببر تا به همه نشون بدی رئیس این بازی کیه!",
                        category = "استادی",
                        target = lvl,
                        currentProgress = 0,
                        isUnlocked = false,
            ...
            profileTargets.forEachIndexed { idx, lvl ->
                initialAchievements.add(
                    AchievementEntity(
                        ...
                        title = "مغز متمرکز ($lvl٪)",
                        description = "درصد تمرکزت رو برسون به $lvl٪ تا چشم بسته بتونی رکود بزنی.",
                        category = "تداوم",
                        target = lvl,
                        currentProgress = 1,
                        isUnlocked = false,
            ...
            coinTargets.forEachIndexed { idx, target ->
                initialAchievements.add(
                    AchievementEntity(
                        id = "coins_$target",
                        title = "پاروکردن پول ($target سکه)",
                        description = "در مجموع $target تا سکه‌ی طلایی تپل و مپل از سطح زمین جمع کن.",
                        category = "اکتشاف",
                        target = target,
                        currentProgress = 0,
                        isUnlocked = false,
